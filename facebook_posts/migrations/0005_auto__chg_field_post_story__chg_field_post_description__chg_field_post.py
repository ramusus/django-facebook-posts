...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Post.story'
        db.alter_column('facebook_posts_post', 'story', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Post.description'
        db.alter_column('facebook_posts_post', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Post.caption'
        db.alter_column('facebook_posts_post', 'caption', self.gf('django.db.models.fields.TextField')())
    def backwards(self, orm):

        # Changing field 'Post.story'
        db.alter_column('facebook_posts_post', 'story', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'Post.description'
        db.alter_column('facebook_posts_post', 'description', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'Post.caption'
        db.alter_column('facebook_posts_post', 'caption', self.gf('django.db.models.fields.CharField')(max_length=500))
    models = {
