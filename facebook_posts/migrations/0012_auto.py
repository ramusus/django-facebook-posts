...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'PostOwner', fields ['owner_id']
        db.create_index(u'facebook_posts_postowner', ['owner_id'])

        # Adding index on 'Comment', fields ['created_time']
        db.create_index(u'facebook_posts_comment', ['created_time'])

        # Adding index on 'Comment', fields ['author_id']
        db.create_index(u'facebook_posts_comment', ['author_id'])

        # Adding index on 'Post', fields ['created_time']
        db.create_index(u'facebook_posts_post', ['created_time'])

        # Adding index on 'Post', fields ['author_id']
        db.create_index(u'facebook_posts_post', ['author_id'])


    def backwards(self, orm):
        # Removing index on 'Post', fields ['author_id']
        db.delete_index(u'facebook_posts_post', ['author_id'])

        # Removing index on 'Post', fields ['created_time']
        db.delete_index(u'facebook_posts_post', ['created_time'])

        # Removing index on 'Comment', fields ['author_id']
        db.delete_index(u'facebook_posts_comment', ['author_id'])

        # Removing index on 'Comment', fields ['created_time']
        db.delete_index(u'facebook_posts_comment', ['created_time'])

        # Removing index on 'PostOwner', fields ['owner_id']
        db.delete_index(u'facebook_posts_postowner', ['owner_id'])
