...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('facebook_posts_post', 'name', self.gf('django.db.models.fields.TextField')())
    def backwards(self, orm):

        # Changing field 'Post.name'
        db.alter_column('facebook_posts_post', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))
    models = {
