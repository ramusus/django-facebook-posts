...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field shares_users on 'Post'
        m2m_table_name = db.shorten_name(u'facebook_posts_post_shares_users')
        db.create_table(m2m_table_name, (
            ...
            ('time_from', models.fields.DateTimeField(null=True, db_index=True)),
            ('time_to', models.fields.DateTimeField(null=True, db_index=True)),
        ))
        db.create_unique(m2m_table_name, ['post_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field shares_users on 'Post'
        db.delete_table(db.shorten_name(u'facebook_posts_post_shares_users'))
