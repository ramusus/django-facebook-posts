...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Comment.likes_real_count'
        db.delete_column(u'facebook_posts_comment', 'likes_real_count')

        # Deleting field 'Post.comments_real_count'
        db.delete_column(u'facebook_posts_post', 'comments_real_count')

        # Deleting field 'Post.likes_real_count'
        db.delete_column(u'facebook_posts_post', 'likes_real_count')


    def backwards(self, orm):
        # Adding field 'Comment.likes_real_count'
        db.add_column(u'facebook_posts_comment', 'likes_real_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Post.comments_real_count'
        db.add_column(u'facebook_posts_post', 'comments_real_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Post.likes_real_count'
        db.add_column(u'facebook_posts_post', 'likes_real_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
