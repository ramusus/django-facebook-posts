...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.expanded_height'
        db.add_column('facebook_posts_post', 'expanded_height',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Post.expanded_width'
        db.add_column('facebook_posts_post', 'expanded_width',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Post.expanded_height'
        db.delete_column('facebook_posts_post', 'expanded_height')

        # Deleting field 'Post.expanded_width'
        db.delete_column('facebook_posts_post', 'expanded_width')
