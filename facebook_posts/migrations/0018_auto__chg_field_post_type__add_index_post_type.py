...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'facebook_posts_post', 'type', self.gf('django.db.models.fields.CharField')(max_length=10))
        # Adding index on 'Post', fields ['type']
        db.create_index(u'facebook_posts_post', ['type'])
