...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'facebook_posts_post', 'graph_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100))

        # Changing field 'Post.link'
        db.alter_column(u'facebook_posts_post', 'link', self.gf('django.db.models.fields.URLField')(max_length=1500))

    def backwards(self, orm):

        # Changing field 'Post.graph_id'
        db.alter_column(u'facebook_posts_post', 'graph_id', self.gf('django.db.models.fields.CharField')(max_length=70, unique=True))
    ...
    models = {
        ...
        u'facebook_posts.post': {
            ...
            'author_content_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'content_type_authors_facebook_posts_posts'", 'null': 'True', 'to': u"orm['contenttypes.ContentType']"}),
            'author_id': ('django.db.models.fields.BigIntegerField', [], {'null': 'True', 'db_index': 'True'}),
            'author_json': ('annoying.fields.JSONField', [], {'null': 'True'}),
            ...
            'link': ('django.db.models.fields.URLField', [], {'max_length': '1500'}),
            'message': ('django.db.models.fields.TextField', [], {}),
