...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('facebook_posts_comment_likes')

        # Adding M2M table for field like_users on 'Comment'
        db.create_table('facebook_posts_comment_like_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('comment', models.ForeignKey(orm['facebook_posts.comment'], null=False)),
            ('user', models.ForeignKey(orm['facebook_users.user'], null=False))
        ))
        db.create_unique('facebook_posts_comment_like_users', ['comment_id', 'user_id'])
        ...
        db.create_table('facebook_posts_post_like_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('post', models.ForeignKey(orm['facebook_posts.post'], null=False)),
            ('user', models.ForeignKey(orm['facebook_users.user'], null=False))
        ))
        db.create_unique('facebook_posts_post_like_users', ['post_id', 'user_id'])

    def backwards(self, orm):
        # Adding M2M table for field likes on 'Comment'
        db.create_table('facebook_posts_comment_likes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('comment', models.ForeignKey(orm['facebook_posts.comment'], null=False)),
            ('user', models.ForeignKey(orm['facebook_users.user'], null=False))
        ))
        db.create_unique('facebook_posts_comment_likes', ['comment_id', 'user_id'])

        # Removing M2M table for field like_users on 'Comment'
        db.delete_table('facebook_posts_comment_like_users')
        ...
        db.delete_table('facebook_posts_post_like_users')
